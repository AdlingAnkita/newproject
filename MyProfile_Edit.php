    ...
    <div class="row row_margin">
        ...
        <div class="col-lg-6 col-md-6  disha_back mb-4">
            <div class="d-flex ">
                ...
                <div class="col-lg-7 col-md-7 ">
                <img class="mx-2 mt-3 dish_img" src="./asset/image/Groupedit.png" alt="">
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6 mb-5 d-flex justify-content-center">
                <div class="d-flex align-items-center justify-content-center">
                    ...
                    <div class="profcard">
                        <h4 class="pt-1 mx-2 proftext ">23rd Sept 2013</h4>
            ...
            <div class="col-lg-6 mb-5 d-flex justify-content-center">
                <div class="d-flex align-items-center justify-content-center">
                    ...
                    <div class="profcard">
                        <h4 class="pt-1 mx-2 proftext ">A.B.C English Medium School</h4>
                        <img class="mx-2 dish_img" src="./asset/image/Groupedit.png" alt="">
                    </div>
                </div>
            ...
            <div class="col-lg-6 mb-5 d-flex justify-content-center">
                <div class="d-flex align-items-center justify-content-center">
                    ...
                    <div class="profcard">
                        <h4 class=" pt-1 mx-2 proftext ">5th Class</h4>
                        <img class="mx-2 dish_img" src="./asset/image/Groupedit.png" alt="">
                    </div>
                </div>
            ...
            <div class="col-lg-6 mb-5 d-flex justify-content-center">
                <div class="d-flex align-items-center justify-content-center">
                    ...
                    <div class="profcard">
                        <h4 class="pt-1 mx-2 proftext ">Mathematics, Science</h4>
                        <img class="mx-2 dish_img" src="./asset/image/Groupedit.png" alt="">
                    </div>
                </div>
            </div>
        <div class="d-flex justify-content-center mb-4" >
            <button class="verifybtn"type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter">Save</button>
        </div>
